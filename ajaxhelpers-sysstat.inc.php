...
function xicore_ajax_get_stat_bar_html($rawval, $label, $displayval, $mult = 20, $maxval = 200, $level2 = 10, $level3 = 50)
{
    ...
    // SLB 2017-01-23 - added  style="text-align:right"
    ...
    $output = '<tr><td><span class="sysstat_stat_subtitle">' . $label . '</span></td><td style="text-align:right">' . $displayval . '</td><td><span class="statbar' . $barclass . '">' . $spanval . '</span></td></tr>';
...
function xicore_ajax_get_server_stats_html($args = null)
{
    ...
    if ($xml == null) {
        ...
        // SLB 2017-01-23 - added  style="text-align:right" - added get_formatted_number
        // $output .= '<tr><td><span class="sysstat_stat_subtitle">' . _('Total') . '</div></td><td>' . $xml->memory->total . ' MB</td><td></td></tr>';
        $output .= '<tr><td><span class="sysstat_stat_subtitle">' . _('Total') . '</div></td><td style="text-align:right">' . get_formatted_number($xml->memory->total, 0 ) . ' MB</td><td></td></tr>';
        ...
        if ($total > 0) { // changed to remove if no swap and remove possibility of division by zero - SW
            ...
            $output .= '<tr><td><span class="sysstat_stat_subtitle">Total</td></td><td style="text-align:right">' . get_formatted_number($xml->swap->total, 0) . ' MB</td><td></td></tr>';
